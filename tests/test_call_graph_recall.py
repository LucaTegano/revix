...
"""
    ...
    found_ref = any(r.symbol_name == "calculate_tax" and r.line == 2 for r in refs)
...
"""
    ...
    found_ref = any(r.symbol_name == "process" and r.line == 6 for r in refs)
...
"""
    ...
    found_ref = any(r.symbol_name == "calculate_tax" for r in refs)
