...
async def test_graph_repo_persist(graph_repo):
    ...
    with patch("app.services.db.graph.db_core.get_pool", return_value=mock_pool):
        await graph_repo.persist_repo_graph("owner/repo", [{"name": "func", "qualified_name": "q", "kind": "f", "file_path": "a.py", "start_line": 1, "end_line": 2, "signature": "s"}], [{"symbol_name": "func", "file_path": "b.py", "line": 1, "context_line": "c", "ref_type": "r"}])
